            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-100 sm:text-center">
                        © 2024
                        <a href="https://kiranbusari.com/" className="hover:underline">
                            kiranbusari
                        </a>
                        . All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <Link to="#" className="text-gray-100 hover:text-blue-600">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                        ...
                        <Link to="#" className="text-gray-100">
                            ...
                            <span className="sr-only text-gray-100">Dribbble account</span>
                        </Link>
                    </div>
                </div>
            </div>
